...
<div style="display: flex;">
	<div style="flex-grow: 1; margin: auto; text-align: center;">
		...
		<c:if test="${groupNo>1}">
			<button type="button" onclick="listDelivering(${startPageNo-1})" 
		...
		<c:if test="${groupNo<totalGroupNum}">
			<button type="button"  onclick="listDelivering(${endPageNo+1})" 
				class="btn btn-outline-info">다음</button>
		</c:if>
		<button type="button" onclick="listDelivering(${totalPageNum})"
