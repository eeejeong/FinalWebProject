	...
	<body>
		...
		<form method="post" action="joinSuccess" onsubmit="return checkForm()">
	    	...
	    	<div class="form-row">
	  		...
	  		<div class="form-row">
			    <!-- <div class="form-group col-md-6">
			      	<label for="agency_address">주소</label>
			      	<input id="agency_address" name="agency_address" type="text" class="form-control" placeholder="agency address">
	    			<span id="agency_addressError" class="error" style="color:red"></span>
			    </div>		 -->	    
			</div>
    	...
    	<!-- 카카오 지도 API -->
			<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=0cef5f118d942254be778baadfb2acb4"></script>
			<script>
